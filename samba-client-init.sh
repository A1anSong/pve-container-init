...
# 创建挂载点目录
sudo mkdir -p /mnt/data.lan

# 添加 fstab 条目，实现开机自动挂载
FSTAB_LINE="//data.lan/public /mnt/data.lan cifs credentials=/root/.smbcredentials,uid=1000,gid=1000,_netdev,x-systemd.requires=network-online.target,x-systemd.after=network-online.target 0 0"
